...
//	 		}
    ...
    public void reduce(Record key, Iterator<Record> values, TaskContext context) throws IOException {
    	long user_is_click1 = 0; // 前一天是否点击过
    	long user_is_click2 = 0; // 前两天是否点击过
    	long user_is_click3 = 0;
    	long user_is_click4 = 0;
    	long user_is_click5 = 0;
    	long user_is_click6 = 0; // 前3小时是否点击过[21,00)
    	long user_is_click7 = 0; // 前6小时是否点击过[18,21)
    	long user_is_click8 = 0; // 前9小时是够点击过[15,18)
    	long user_is_click9 = 0; // 前12小时是够点击过[12,15)
    	long user_is_click10 = 0; // 前15小时是够点击过[9,12)
    	long user_is_click11 = 0; // 前18小时是够点击过[6,9)
    	long user_is_click12 = 0; // 前21小时是够点击过[3,6)
    	long user_is_click13 = 0; // 前24小时是够点击过[0,3)

    	long user_is_cart1 = 0; // 前一天是否点加购
    	long user_is_cart2 = 0; // 前两天是否点加购
    	long user_is_cart3 = 0;
    	long user_is_cart4 = 0;
    	long user_is_cart5 = 0;
    	long user_is_cart6 = 0; // 前3小时是否点加购[21,00)
    	long user_is_cart7 = 0; // 前6小时是否点加购[18,21)
    	long user_is_cart8 = 0; // 前9小时是够点加购[15,18)
    	long user_is_cart9 = 0; // 前12小时是够点加购[12,15)
    	long user_is_cart10 = 0; // 前15小时是够点加购[9,12)
    	long user_is_cart11 = 0; // 前18小时是够点加购[6,9)
    	long user_is_cart12 = 0; // 前21小时是够点加购[3,6)
    	long user_is_cart13 = 0; // 前24小时是够点加购[0,3)
    	
    	long user_is_colle1 = 0; // 前一天是否点收藏
    	long user_is_colle2 = 0; // 前两天是否点收藏
    	long user_is_colle3 = 0;
    	long user_is_colle4 = 0;
    	long user_is_colle5 = 0;
    	long user_is_colle6 = 0; // 前3小时是否点收藏[21,00)
    	long user_is_colle7 = 0; // 前6小时是否点收藏[18,21)
    	long user_is_colle8 = 0; // 前9小时是够点收藏[15,18)
    	long user_is_colle9 = 0; // 前12小时是够点收藏[12,15)
    	long user_is_colle10 = 0; // 前15小时是够点收藏[9,12)
    	long user_is_colle11 = 0; // 前18小时是够点收藏[6,9)
    	long user_is_colle12 = 0; // 前21小时是够点收藏[3,6)
    	long user_is_colle13 = 0; // 前24小时是够点收藏[0,3)
    	
    	double user_click1 = 0; //前一天点击数目，时间衰减下的点击数目
    	double user_click2 = 0; //前两天点击数目，包括1,2两天数目
    	double user_click3 = 0;
    	double user_click4 = 0;
    	double user_click5 = 0;
    	double user_click6 = 0;
    	
    	double user_cart1 = 0; //包括收藏和加购行为
    	double user_cart2 = 0;
    	double user_cart3 = 0;
    	double user_cart4 = 0;
    	double user_cart5 = 0;
    	...
    	//TODO 这里31是否正确
    	long user_first_active = 32; //用户第一次交互商品到购买日的天数
    	long user_last_active = 32;
    	
    	long user_first_buy = 32; //用户第一次购买商品到购买日的天数
    	long user_last_buy = 32;
    	
//    	long user_first_last_buy = 32; //用户第一次购买到用户最近一次购买间隔天数
//    	long user_first_last_active = 32;
    	...
    	// 标记前六天
    	long user_is_only_click = 0; //是否只有点击行为
    	long user_is_only_cart = 0;
    	long user_is_only_colle = 0;
    	long user_is_only_buy = 0;
    	long user_is_click_buy = 0;
    	long user_is_click_and_cart = 0;
    	long user_is_click_and_colle = 0;
    	long user_is_click_and_cart_buy = 0;
    	long user_is_click_and_colle_buy = 0;
    	long user_is_click_and_cart_colle = 0;
    	long user_is_click_and_cart_colle_buy = 0;
    	
    	long user_active_day = 0; //总共的交互天数
        ...
        while (values.hasNext()) {
    		...
    		if (day > 0) {
    			if (user_first_active == 32) {
    				//用户A对商品B的第一次交互离购买日的天数
    				user_first_active = day;
    			} else if (user_first_active < day) {
    				user_first_active = day;
    			}
    			
    			if (user_last_active == 32) {
    				user_last_active = day;
    			} else if (user_last_active > day) {
    				user_last_active = day;
    			}
    		}
        ...
        user_click1 = temp1; // 前一天点击数目
        user_click2 = temp1 + temp2;
        user_click3 = temp1 + temp2 + temp3;
        user_click4 = temp1 + temp2 + temp3 + temp4;
        user_click5 = temp1 + temp2 + temp3 + temp4 + temp5;
        user_click6 = temp1 + temp2 + temp3 + temp4 + temp5 + temp6;
        ...
        user_cart1 = temp1; // 前一天加购或收藏数目
        user_cart2 = temp1 + temp2;
        user_cart3 = temp1 + temp2 + temp3;
        user_cart4 = temp1 + temp2 + temp3 + temp4;
        user_cart5 = temp1 + temp2 + temp3 + temp4 + temp5;
        user_cart6 = temp1 + temp2 + temp3 + temp4 + temp5 + temp6;
        

        
        if (flag1 == 1 && flag2 == 0 && flag3 == 0 && flag4 == 0) {
        	user_is_only_click = 1;
        } else if (flag1 == 0 && flag2 == 1 && flag3 == 0 && flag4 == 0) {
        	user_is_only_colle = 1;
        	...
        	user_is_click_and_cart = 1;
        } else if (flag1 == 1 && flag2 == 1 && flag3 == 0 && flag4 == 0) {
        	user_is_click_and_colle = 1;
        } else if (flag1 == 1 && flag2 == 0 && flag3 == 1 && flag4 == 1) {
        	user_is_click_and_cart_buy = 1;
        } else if (flag1 == 1 && flag2 == 1 && flag3 == 0 && flag4 == 1) {
        	user_is_click_and_colle_buy = 1;
        } else if (flag1 == 1 && flag2 == 1 && flag3 == 1 && flag4 == 0) {
        	user_is_click_and_cart_colle = 1;
        } else if (flag1 == 1 && flag2 == 1 && flag3 == 1 && flag4 == 1) {
        	user_is_click_and_cart_colle_buy = 1;
        }
        
        if (isOnlyBefore == true) {
            result.set(0, key.getString("user_id"));
            
            result.set(1, user_is_click1);
            result.set(2, user_is_click2);
            result.set(3, user_is_click3);
            result.set(4, user_is_click4);
            result.set(5, user_is_click5);
            result.set(6, user_is_click6);
            result.set(7, user_is_click7);
            result.set(8, user_is_click8);
            result.set(9, user_is_click9);
            result.set(10, user_is_click10);
            result.set(11, user_is_click11);
            result.set(12, user_is_click12);
            result.set(13, user_is_click13);
            
            result.set(14, user_is_cart1);
            result.set(15, user_is_cart2);
            result.set(16, user_is_cart3);
            result.set(17, user_is_cart4);
            result.set(18, user_is_cart5);
            result.set(19, user_is_cart6);
            result.set(20, user_is_cart7);
            result.set(21, user_is_cart8);
            result.set(22, user_is_cart9);
            result.set(23, user_is_cart10);
            result.set(24, user_is_cart11);
            result.set(25, user_is_cart12);
            result.set(26, user_is_cart13);
            
            result.set(27, user_is_colle1);
            result.set(28, user_is_colle2);
            result.set(29, user_is_colle3);
            result.set(30, user_is_colle4);
            result.set(31, user_is_colle5);
            result.set(32, user_is_colle6);
            result.set(33, user_is_colle7);
            result.set(34, user_is_colle8);
            result.set(35, user_is_colle9);
            result.set(36, user_is_colle10);
            result.set(37, user_is_colle11);
            result.set(38, user_is_colle12);
            result.set(39, user_is_colle13);
            
            result.set(40, user_click1);
            result.set(41, user_click2);
            result.set(42, user_click3);
            result.set(43, user_click4);
            result.set(44, user_click5);
            result.set(45, user_click6);
           
            result.set(46, user_cart1);
            result.set(47, user_cart2);
            result.set(48, user_cart3);
            result.set(49, user_cart4);
            result.set(50, user_cart5);
            result.set(51, user_cart6);
            
            
            result.set(52, user_first_active);
            result.set(53, user_last_active);

            
            result.set(54, user_first_buy);
            result.set(55, user_last_buy);
            
            result.set(56, user_is_only_click);
            result.set(57, user_is_only_cart);
            result.set(58, user_is_only_colle);
            result.set(59, user_is_only_buy);
            result.set(60, user_is_click_buy);
            result.set(61, user_is_click_and_cart);
            result.set(62, user_is_click_and_colle);
            result.set(63, user_is_click_and_cart_buy);
            result.set(64, user_is_click_and_colle_buy);
            result.set(65, user_is_click_and_cart_colle);
            result.set(66, user_is_click_and_cart_colle_buy);
            
            result.set(67, user_active_day);
