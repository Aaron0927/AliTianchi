...
//	 		}
    ...
    public void reduce(Record key, Iterator<Record> values, TaskContext context) throws IOException {
        ...
        little_category_buy_day_1 = userCounter1.size();
        little_category_buy_day_3 = userCounter3.size();
        little_category_buy_day_5 = userCounter5.size();
        
        little_category_buy_user_1 = dayCounter1.size();
        little_category_buy_user_3 = dayCounter3.size();
        little_category_buy_user_5 = dayCounter5.size();
        ...
        if(temp_day2 > 0 && temp_day3 > 0) {
        	little_category_buy_increase =  ((little_category_buy_1 - temp_day2) * 1.0 / temp_day2 +
        			(temp_day2 - temp_day3) / temp_day3) / 2.0;
        }
